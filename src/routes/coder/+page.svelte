<script lang="ts">
	...
	let x = 0;
	let y = 0;
	function mouseHandler(t: { currentTarget: any; clientX: any; clientY: any; }) {
...
>
	<div>
		<div
			class="__variable_20b187 group/spotlight relative"
			role="article"
			on:mousemove={mouseHandler}
		>
			<div
				class="pointer-events-none fixed inset-0 z-30 transition duration-300 lg:absolute"
				style="background: radial-gradient(600px at {x}px {y}px, rgba(29, 78, 216, 0.15), transparent 80%);"
			></div>
			...
			>
				...
				<div class="lg:flex lg:justify-between lg:gap-4">
						...
						<ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
							...
							<li class="mr-5 shrink-0 text-xs">
								<a
									...
									title="CodePen"
									><span class="sr-only">CodePen</span><svg
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 64 64"
										fill="none"
										stroke="currentColor"
                  ...
                  <li class="mb-12">
									...
									<li class="mb-12">
										<TimelineEntryCard
                    timeFrame='July — Dec 2017'
                    role='UI Engineer Co-op'
                    companyName='Apple'
                    description='Developed and styled interactive web apps for Apple Music, including the
                    user interface of Apple Music’s embeddable web player widget for
                    ...
                    ></TimelineEntryCard>
								...
								<div class="mt-12">
									<a
										class="group/link inline-flex items-baseline text-base font-medium font-semibold leading-tight text-slate-200 text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
										href="/resume.pdf"
										target="_blank"
										rel="noreferrer noopener"
										aria-label="View Full Résumé (opens in a new tab)"
										><span
											>View Full <span class="inline-block"
												>Résumé<svg
													xmlns="http://www.w3.org/2000/svg"
													viewBox="0 0 20 20"
													fill="currentColor"
											...
											<div class="z-10 sm:order-2 sm:col-span-6">
												<h3>
													<a
														...
														></span><span
															>Build a Spotify Connected <span class="inline-block"
																>App<svg
																	xmlns="http://www.w3.org/2000/svg"
																	viewBox="0 0 20 20"
																	fill="currentColor"
										...
										>
											...
											<div class="z-10 sm:order-2 sm:col-span-6">
												...
												<a
													...
													target="_blank"
													rel="noreferrer noopener"
													aria-label="6994 stars on GitHub (opens in a new tab)"
													><svg
														xmlns="http://www.w3.org/2000/svg"
														viewBox="0 0 20 20"
														fill="currentColor"
												...
												<h3 class="-mt-1">
													<a
														...
														><span
															class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"
														></span><span
															>Integrating Algolia Search with WordPress <span class="inline-block"
																>Multisite<svg
																	xmlns="http://www.w3.org/2000/svg"
																	viewBox="0 0 20 20"
																	fill="currentColor"
												...
												<h3 class="-mt-1">
													<a
														...
														><span
															class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"
														></span><span
															>Building a Headless Mobile App CMS From <span class="inline-block"
																>Scratch<svg
																	xmlns="http://www.w3.org/2000/svg"
																	viewBox="0 0 20 20"
																	fill="currentColor"
						...
						<footer class="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
							<p>
								Adapted <a
									...
									target="_blank"
									rel="noreferrer noopener"
									aria-label="https://brittanychiang.com (opens in a new tab)">Brittany Chiang's</a
								>
                design. I built the site with
								<a
									href="https://svelte.dev/"
									class="font-medium text-slate-400 hover:text-teal-300 focus-visible:text-teal-300"
									target="_blank"
									rel="noreferrer noopener"
									aria-label="Svelte (opens in a new tab)">Svelte</a
								>
								and
								<a
								...
								<a
									...
									target="_blank"
									rel="noreferrer noopener"
									aria-label="Netlify (opens in a new tab)">Netlify</a
								>. 
							</p>
						</footer>
					</main>
